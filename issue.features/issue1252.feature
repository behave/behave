...
Feature: Issue #1252 -- Wrong encoding of Unicode text (czech diacritics) in html report
  ...
  @use.with_platform=aix
  @use.with_platform=cygwin
  @use.with_platform=darwin
  @use.with_platform=linux
  ...
  @xfail
  @use.with_platform=win32
  Scenario: Syndrome on Windows platform
